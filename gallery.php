...
<div class="container mb-5 mt-2">
    ...
    <div class="dropdown row w-100 mb-2">
        ...
        <ul class="dropdown-menu1 bg-secondary" role="menu" aria-labelledby="menu2" id="19">
            <div class="row"><a class="btn btn-secondary" href="" role="button">ZPV Horní Suchá - 19.10.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">NDT Rychvald - 6.10.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Těrlicko Hradiště - 28.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Bohumín Kopytov - 28.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Dorost, Orlová Poruba - 21.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Orlová Poruba - 21.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Chotěbuz - 15.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">TFA Bobrovníky - 14.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Horní Suchá - 14.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Vrbice - 9.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Dorost, Rychvald - 7.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Rychvald - 7.9.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výlet na Skalku - 3.8. - 8.8.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Petrovice Závada - 23.6.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, TFA Horní Suchá - 22.6.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Karviná Hranice - 9.6.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Skřečoň - 8.6.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Bohumín Skřečoň - 8.6.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Dorost, Okresní kolo Český Těšín - 27.5.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Plamen - 26.5.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ukázka na ZŠ - 3.5.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, Orlová Město - 4.5.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Okrsková soutěž, Doubrava - 27.4.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, TFA Dolní Lutyně - 27.4.2019</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, exkurze HBZS - 27.3.2019</a></div>
        </ul>
    </div>
    <div class="dropdown row w-100 mb-2">
        ...
        <ul class="dropdown-menu1 bg-secondary" role="menu" aria-labelledby="menu2" id="18">
            ...
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH, exkurze HZS MSK Ostrava Zábřeh - 25.1.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MěÚ předání ocenění 6.2.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Hala Havířov - 17.2.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pochování Basy - 3.3.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MDŽ - 10.3.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Josefovská soutěže - 17.3.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Hala Petrovice - 24.3.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - TFA Petřvald - 7.4.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Okrskový turnaj ve stolním tenise - 14.4.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - TFA Dolní Lutyně - 21.4.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Karneval - 25.4.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Okrsek Orlová - 28.4.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Orlová Město - 5.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - PLAMEN - 19.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Okresní Kolo - 20.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pomoc při branném dni na ZŠ - 25.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Orlová Poruba - soutěž - 26.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Šunychl - soutěž - 26.5.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Orlová Poruba - 2.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Orlová Město - soutěž - 2.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Petrovice Závada - 17.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Bohumín Záblatí - 17.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Doubrava - soutěž - 23.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Záblatí - soutěž - 23.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Petřvald - 30.6.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">chata Skalka - 6.8 - 9.8.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Orlová Poruba - soutěž - 1.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Doubrava - soutěž - 1.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Rychvald - 8.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Záblatí - noční soutěž - 8.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Horní Suchá - 15.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Hasiči 100 let OSP Krzyzowice</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Dětmarovice - soutěž - 15.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Vrbice - 16.9.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">VH a sázení pamětní lípy ke 100.letému výročí</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - TFA Horní Suchá - 6.10.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Havířov Město - soutěž - 6.10.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Bobová dráha - 10.10.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Branný závod - 13.10.2018</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Dorost, - Orlová Poruba - 21.10.2018</a></div>
        </ul>
    </div>
    <div class="dropdown row w-100 mb-2">
        ...
        <ul class="dropdown-menu1 bg-secondary" role="menu" aria-labelledby="menu2" id="17">
            <div class="row"><a class="btn btn-secondary" href="" role="button">JSDH - Cvičení - 18.2.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Hala Havířov - 25.2.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - exkurze, HZS MSK - Ostrava Přívoz - 1.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pochování Basy - 4.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Hala Petrovice - 11.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MDŽ - 11.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Josefovská soutěž - 18.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Karneval - 22.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Plnění odznaků odborností - 31.3.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Hasičské muzeum Polsko Myslowice - 22.4.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ukázka - 1.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Křest auta Tatra 815 - 5.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Orlová Město - 6.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Těrlicko Hradiště - 13.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Plamen - 20.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Šunychl - soutěž - 27.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Globus CUP v Opavě - 28.5.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Doubrava - 10.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Karviná Hranice - 11.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Bohumín Záblatí - 17.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Petrovice Závada - 18.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Orlová Město - soutěž - 24.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Petřvald - 24.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Havířov Město - 25.6.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Letní slavnosti a soutěž - 5.7.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Záblatí - soutěž - 22.7.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Námětové cvičení Okrsku Orlová - 25.7.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Dolní Marklovice, sání z řeky - soutěž - 5.8.2017 </a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výlet MH, chata Skalka - 7.8.-10.8.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Petřvald - soutěž - 12.8.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Doubrava - sání - 19.8.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Bohumín Záblatí - noční soutěž - 19.8.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">TFA, FIREFIGHTERS CHALENGE - Ludgeřovice - 2.9.207</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Rychvald - 10.9.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Vrbice - 11.9.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Havířov město - soutěž - 7.10.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Kopytov - soutěž - 8.10.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Kopytov - 8.10.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Závod požárnické všestrannosti - 14.10.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">NDT - Kopytov - 15.10.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - výzdoba - 29.11.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Mikuláš - 6.12.2017</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Vánoční - 20.12.2017</a></div>
        </ul>
    </div>
    <div class="dropdown row w-100 mb-2">
    ...
    <div class="dropdown row w-100 mb-2">
        ...
        <ul class="dropdown-menu1 bg-secondary" role="menu" aria-labelledby="menu2" id="15">
            ...
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výroční Valná Hromada - 24.1.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ples - 21.2.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pochování Basy - 7.3.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Josefovská soutěž - 14.3.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ukázka pro MŠ - 17.3.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Jednotka, oprava majáku - 22.3.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Jednotka, oprava majáku - 22.3.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Krzyzowice - křest auta - 26.4.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ukázka na dětském májovém dopoledni 1.5.2015</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button"></a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button"></a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button"></a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button"></a></div>
    ...
    <div class="dropdown row w-100 mb-2">
        ...
        <ul class="dropdown-menu1 bg-secondary" role="menu" aria-labelledby="menu2" id="14">
            <div class="row"><a class="btn btn-secondary" href="" role="button">Odchyt papouška - 4.1.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výroční Valná Hromada - 18.1.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Ples - 15.2.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pochování Basy - 1.3.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MDŽ - 8.3.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Školení jednotky + voda - 9.3.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Návštěva školy na HZ - 20.3.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Josefovská soutěž - 2.3.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Jednotka, číštění studny - 6.4.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Protáčení mašiny + kondiční jízdy - 20.4.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Varrock, cvičení - 26.4.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Pszczyna - 11.5.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Smažení vaječiny - 7.6.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž Ka Hranice - 8.6.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž Doubrava - 14.6.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž Doubrava - 14.6.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH výlet - 29.6-30.6.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Soutěž a letní slavnosti - 5.7.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Mezinárodní soutěž - 12.7.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Soutěž Doubrava + ukázka Rychvald - 23.8.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Soutěž - Orlová Poruba - 30.8.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž Č.T.Mosty - 7.9.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž Rychvald 13.9.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Soutěž Dětmarovice - 13.9.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výjezdní zasedání - 20.9.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - soutěž PL Jaworzno</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Soutěž Orlová Město NDT - 11.10.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">TFA Karviná - 18.10.214</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Výcvikový rok + mikulášská 6.12.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">MH - Mikuláš 17.12.2014</a></div>
            <div class="row"><a class="btn btn-secondary" href="" role="button">Jednotka - prověřovací cvičení - 20.12.2014</a></div>
        </ul>
    </div>
    <div class="dropdown row w-100 mb-2">
